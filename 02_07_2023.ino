...
LiquidCrystal_I2C lcd(0x3F, 16, 2); // set the LCD address to 0x3F for a 20 chars and 4 line display
...
const String ssid = "Altamar"; // "Redmi Note 9"; // "Saturno"; // "Redmi Note 9"; //                                //The name of the Wi-Fi network you are connecting to

const String pass = "2021hepatus";  //"Pedro0123"; // "familia1";  // "Pedro0123"; //                           //Your WiFi network password
...
void thingspeak_send() {                                          //if we're datalogging
  if (wifi_isconnected()) {
    ...
    if (return_code == 200) {                                                          //code for successful transmission
      ...
      Serial.print("couldnt send to thingspeak, ERROR: ");
...
void myTimerEvent()
{
  ...
  Blynk.virtualWrite(V12, RTD_float);
  delay(500);
  Blynk.virtualWrite(V13, ph_float);
  delay(500);
  Blynk.virtualWrite(V14, DO_float);
  delay(500);
  Blynk.virtualWrite(V15, ORP_float);
  delay(500);
  Blynk.virtualWrite(V16, ec_float);
  delay(500);
  Blynk.virtualWrite(V17, sal_float);
  delay(500);
}
...
void setup() {                                                                    //set up the hardware
  ...
  if (modolocal == 0)
  {
    Blynk.begin(auth, "Altamar", "2021hepatus"); //(auth,"Redmi Note 9","Pedro0123"); // (auth,"Saturno","familia1"); //
  ...
  while (mcp.digitalRead(botaosair) == HIGH)
  {
    ...
    if ( mcp.digitalRead(botaoentrar) == LOW)
    {
      while ( mcp.digitalRead(botaosair) == HIGH)
      {
        lcd.clear();
        lcd.setCursor(0, 0);
        lcd.print("Selecionado RTD");
        lcd.setCursor(0, 1);
        lcd.print("PRESS P CAL");
        delay(2000);
        if ( mcp.digitalRead(botaoentrar) == LOW)
        {
...
void part2()
{
  ...
  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print("Variaveis e");
  lcd.setCursor(0, 1);
  lcd.print("Saidas: "); // You can make spaces using well... spaces
  delay(1000);
...
void condicoes()
{
  ...
  Serial.print("Rele 05: ");
  Serial.println(rele5);
  Serial.print("Rele 06: ");
  Serial.println(rele6);
  Serial.print("Rele 07: ");
  Serial.println(rele7);
  Serial.print("Rele 08: ");
  Serial.println(rele8);
  Serial.print("Rele 09: ");
  Serial.println(rele9);
  Serial.print("Rele 10: ");
  Serial.println(rele10);
  Serial.print("Rele 11: ");
  Serial.println(rele11);
  Serial.print("Rele 12: ");
...

{
  ...
  Serial.print("Tempo de Ajuste Temperatura: ");
  Serial.print(blynk_tempo_temp);
  Serial.println(" em minutos ");

  Serial.print("Tempo de Ajuste PH: ");
  Serial.print(blynk_tempo_ph);
  Serial.println(" em minutos ");

  Serial.print("Tempo de Ajuste DO: ");
  Serial.print(blynk_tempo_do);
  Serial.println(" em minutos ");

  Serial.print("Tempo de Ajuste ORP: ");
  Serial.print(blynk_tempo_orp);
  Serial.println(" em minutos ");

  Serial.print("Tempo de Ajuste EC: ");
  Serial.print(blynk_tempo_ec);
  Serial.println(" em minutos ");

  Serial.print("Range Temperatura Alvo: ");
  Serial.print(blynk_temp_min);
  Serial.print(" - ");
  Serial.println(blynk_temp_max);

  Serial.print("Range pH Alvo: ");
  Serial.print(blynk_ph_min);
  Serial.print(" - ");
  Serial.println(blynk_ph_max);

  Serial.print("Range DO Alvo: ");
  Serial.print(blynk_do_min);
  Serial.print(" - ");
  Serial.println(blynk_do_max);

  Serial.print("Range ORP Alvo: ");
  Serial.print(blynk_orp_min);
  Serial.print(" - ");
  Serial.println(blynk_orp_max);

  Serial.print("Range Condutividade Alvo: ");
  Serial.print(blynk_cond_min);
  Serial.print(" - ");
  Serial.println(blynk_cond_max);

  Serial.print("Range Salinidade Alvo: ");
  Serial.print(blynk_sal_min);
  Serial.print(" - ");
