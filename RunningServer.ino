...
const String ssid = "CLARO_2G6469F3"; // "Redmi Note 9"; // "Saturno"; // "Redmi Note 9"; //                                //The name of the Wi-Fi network you are connecting to

const String pass = "C96469F3";  //"Pedro0123"; // "familia1";  // "Pedro0123"; //                           //Your WiFi network password
  ...
  if (client) {
    ...
    while (client.connected()) {
      ...
      if (client.available()) {
        ...
        Serial.print("GET DOS GET: " + request);
          ...
          for (const String& param : paramList) {
            ...
            if (keyValue.size() == 2) {
              ...
              if (paramName == "temp_min") {
                  blynk_temp_min = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_temp_min);
                  compare(blynk_temp_min);
              } else if (paramName == "temp_max") {
                  blynk_temp_max = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_temp_max);
                  compare(blynk_temp_max);
              } else if (paramName == "ph_min") {
                  blynk_ph_min = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_ph_min);
                  compare(blynk_ph_min);
              } else if (paramName == "ph_max") {
                  blynk_ph_max = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_ph_max);
                  compare(blynk_ph_max);
              } else if (paramName == "o2_min") {
                  blynk_orp_min = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_orp_min);
                  compare(blynk_orp_min);
              } else if (paramName == "o2_max") {
                  blynk_orp_max = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_orp_max);
                  compare(blynk_orp_max);
              } else if (paramName == "ox_max") {
                  blynk_do_max = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_do_max);
                  compare(blynk_do_max);
              } else if (paramName == "ox_min") {
                  blynk_do_min = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_do_min);
                  compare(blynk_do_min);
              } else if (paramName == "sal_min") {
                  blynk_sal_min = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_sal_min);
                  compare(blynk_sal_min);
              } else if (paramName == "sal_max") {
                  blynk_sal_max = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_sal_max);
                  compare(blynk_sal_max);
              } else if (paramName == "cond_max") {
                  blynk_cond_max = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_cond_max);
                  compare(blynk_cond_max);
              }  else if (paramName == "cond_min") {
                  blynk_cond_min = atof(paramValue.c_str());
                  Serial.println("Temp: " + (String) blynk_cond_min);
                  compare(blynk_cond_min);
              }
            }
          }
        }

        String HTTP_REQUEST_IP = "192.168.0.19";
        delay(5000); 
