...
LiquidCrystal_I2C lcd(0x3F, 16, 2); // set the Serial address to 0x3F for a 20 chars and 4 line display
...
const String ssid = "thomh"; //"CLARO_2G6469F3"; // "Redmi Note 9"; // "Saturno"; // "Redmi Note 9"; //                                //The name of the Wi-Fi network you are connecting to

const String pass = "thom44556677"; //"C96469F3";  //"Pedro0123"; // "familia1";  // "Pedro0123"; //                           //Your WiFi network password
...
void readFromThingspeak() {
  ...
  delay(5000);
    String a = urlGetThingspeak("2422964", (String)i, "40EXWJPSN80PFOFU");
    String b = "";

    WiFiClient c;
    if (c.connect("api.thingspeak.com", 80)) {
      c.print("GET " + a + " HTTP/1.1\r\n" +
  ...
  if (modomanual == 1) {
    ...
    switch(i) {
      ...
      case 2:
        lcd.clear();
        lcd.setCursor(0, 0);
        rele2 = atof(field.c_str());
        lcd.print(rele2);
        break;
      case 3:
        lcd.clear();
        lcd.setCursor(0, 0);
        rele3 = atof(field.c_str());
        lcd.print(rele3);
        break;
      case 4:
        lcd.clear();
        lcd.setCursor(0, 0);
        rele4 = atof(field.c_str());
        lcd.print(rele4);
        break;
      case 5:
        lcd.clear();
        lcd.setCursor(0, 0);
        rele5 = atof(field.c_str());
        lcd.print(rele5);
        break;
      case 6:
        lcd.clear();
        lcd.setCursor(0, 0);
        rele6 = atof(field.c_str());
        lcd.print(rele6);
        break;
      default:
        break; 
...
void loop() {
  ...
  lcd.print("3 - Rotina: ");
  lcd.setCursor(0, 1);
  lcd.print("Recebe limites do Thingspeak"); //     Mudar: Le do Thingspeak os limetes
  delay(5000);

  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print("Lendo do thingspeak...");
  readFromThingspeak();
  lcd.clear();
  lcd.setCursor(0, 0);
